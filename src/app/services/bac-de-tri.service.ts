...
export class BacDeTriService {
  ...
  private sorting_bin: BacDeTri[] = [
    ...
    {name: 'Petits cartons', img: 'CartonPlie.png', arrayName : ['Petit', 'Carton', 'Petit carton', ' Carton']},
    ...
    {name: 'Emballages Repas en Carton', img: 'EmballageCarton.png', arrayName : ['Emballage', 'Carton', 'Emballage en carton', 'Repas', ' Carton', 'Boîte']},
